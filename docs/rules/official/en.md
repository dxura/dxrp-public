...
- Use of server scripts against their intended purpose, exploits, cheats, or macros/autoclickers will not be tolerated
  - This includes unlocking and relocking doors that are being pry barred to reset the timer
...
- You cannot mug for more than **💰 $1,000**
- You cannot mug more than once every **⏰ 5 minutes**
- You cannot target a specific person for repeated muggings
- Give a reasonable amount of time for people to respond to you when mugging (minimum 10 seconds)
- **Jobs that cannot mug:** All Dealers, All Government, Theatre Manager, and Medic
...
- Prop flinging / climbing / flying / spamming
- Using Wire components to annoy other users

---

## 🆘 What to Do When a Rule is Broken

### Option 1: Contact Staff In-Game

Players with the **"staff"** tag in-game are there to help you. They can warn, kick, and ban players.

### Option 2: Contact a Trusted Member

If no staff are available and the issue is major, players with the **"trusted"** tag can kick in severe situations. They will not kick for minor infractions like a few RDMs or RDAs.

### Option 3: Report on Discord

If no one is online to help you, join the Discord server and make a player report. Make sure to have video evidence if needed, and the offending player's ID.

---

## 📝 How to Make a Report

- Most reports will require proof, such as a clip. Always include enough context before and after the incident
- If on Discord, go to the **#player-reports** channel and create a ticket with the player's name and Steam ID
- **Lying on a report will get you punished**, and so will behaving disrespectfully
- For recording, software such as the Steam recording system or Medal is recommended

---

**Thank you for reading the rules. Have fun and play fair!**
